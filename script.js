// Initial settings for various accessibility features
...
// This function sets accessibility options based on user input
...
async function parse() {
    ...
    try {
      ...
      const requestBody = JSON.stringify({
        ...
        prompt: "Summarize the text and ignore advertisments. Make the only output a clear 5 to 6 detailed sentences. Before the summary, construct one sentence that encapsulates the main message of the webpage. This is the text: " + pageHTML,
        max_tokens: 300
      });
...
// Screenshot ___________________________________________________________________
function ss() {
...
// Color Contrast _______________________________________________________________________________________________________________
